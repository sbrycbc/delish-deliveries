...
const Cart = () => {
  ...
  return (
    <Helmet title="Warenkorb">
      <CommonSection title="Dein WarenKorb" />
      <section>
        <Container>
          <Row>
            <Col lg="12">
              {cartItems.length === 0 ? (
                <h5 className="text-center">Dein Warenkorb ist leer!</h5>
              ) : (
              ...
              <div className="mt-4">
                <h6>
                  Summe: €<span className="cart_subtotal">{totalAmount}</span>
                </h6>
                <p className="card_page-info">
                  Alle Preise in € inkl. gestzl MwSt.
                  <br />
